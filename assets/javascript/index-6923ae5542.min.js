!(function (t) {
    ...
    !(function (s, r) {
      ...
      function r(r) {
        if (
          ...
          r && 'object' == (void 0 === r ? 'undefined' : s(r)) && r.nodeType)
        ) {
          var a = i(r)
          ...
          for (
            var c = (u.isBorderBox = 'border-box' == a.boxSizing), f = 0;
            f < l;
            f++
          ) {
            var p = h[f],
          ...
          var m = u.paddingLeft + u.paddingRight,
            ...
            T = c && o,
            w = t(a.width)
          !1 !== w && (u.width = w + (T ? 0 : m + x))
          var P = t(a.height)
          return (
            !1 !== P && (u.height = P + (T ? 0 : g + b)),
  ...
  function (t, e, i) {
    ...
    !(function (o, a) {
      ;(s = [i(0), i(1)]),
        void 0 !== (r = 'function' == typeof (n = a) ? n.apply(e, s) : n) &&
          (t.exports = r)
    })(window, function (t, e) {
      function i(t) {
        ;(this.isotope = t),
  ...
  function (t, e, i) {
    ...
    'function' == typeof Symbol && Symbol.iterator
    !(function (r, o) {
      void 0 !== (s = 'function' == typeof (n = o) ? n.call(e, i, e, t) : n) &&
        (t.exports = s)
    ...
    function n(t) {
      function e() {
        ...
        ;(t = this.options.content),
          ...
          ((e = document.createElement('article')).id = 'modalContainer'),
          (e.className = 'modal__container'),
          (e.innerHTML = t),
        ...
        ;(n.id = 'closefx'), (n.className = 'modal__closefx')
        var s = document.createElement('div')
        ;(s.id = 'closex'),
          (s.className = 'modal__closex'),
          n.appendChild(s),
          this.closeButton.appendChild(n),
          e.appendChild(this.closeButton),
          i.appendChild(this.modal),
          document.body.appendChild(i)
      }
      function i() {
        var t = this
        ;(window.onpopstate = function () {
          ;-1 === window.location.href.indexOf('#' + t.options.name) &&
            t.close()
        }),
      ...
      var u = this
      ;(this.modal = null), (this.closeButton = null)
      var c = {
        name: '',
        className: '',
        content: '',
      ...
      ;(this.options = s({}, c, t)),
        (n.prototype.open = function () {
          'function' == typeof u.options.willMount
            ? u.options.willMount(function () {
                return l.call(u)
              })
            : l.call(u)
        }),
        (n.prototype.close = function () {
          a.call(u),
            'function' == typeof u.options.willUnmount
              ? u.options.willUnmount(function () {
                  return h.call(u)
                })
              : h.call(u)
        })
  ...
  function (t, e, i) {
    ...
    ;(window.onload = function () {
      ;(0, a.default)(r.default)('.gallery__item'), l.curtain.open()
    }),
      document.addEventListener('DOMContentLoaded', function () {
        !(function () {
          function t(t) {
            new h.default(s({}, t, i)).open()
          }
          var e = {
              colorhappy: { name: 'colorhappy', content: o.ch },
              reactsound: { name: 'reactsound', content: o.rs },
              amanything: { name: 'amanything', content: o.ama },
              snvote: { name: 'snvote', content: o.snv },
            },
            i = {
              willMount: function (t) {
                l.curtain.close({ onComplete: t })
              },
              didMount: function (t) {
                var e = document.getElementById('showcase'),
                  i = document.getElementById('closefx')
                ;(0, r.default)(e, function () {
                  l.curtain.open({ onComplete: t })
                }),
              ...
              willUnmount: function (t) {
                l.curtain.close({ onComplete: t })
              },
              didUnmount: function (t) {
                l.curtain.open({ onComplete: t })
              },
            },
            n = Object.keys(e),
            a = String(window.location.hash.split('#')[1])
          ;-1 !== n.indexOf(a) && t(e[a]),
            // (function (e) {
            //   n.forEach(function (i) {
            //     document
            //       .getElementById('anchor__' + i)
          ...
          (0, a.default)(r.default)('.gallery__item')
      })
  },
  function (t, e, i) {
    'use strict'
    ;(function (n) {
      var s,
        ...
        a = void 0 !== t && t.exports && void 0 !== n ? n : window
        ...
        a._gsDefine(
          ...
          function (t, e, i) {
                    ...
                    ? ((this._totalTime = _),
                      ...
                      0 === v &&
                        ...
                        (0 > x ||
                          ...
                          x !== t &&
                          ((n = !0), x > o && (r = 'onReverseComplete')),
                        (this._rawPrevTime = p = !e || t || x === t ? t : o)))
                    : 1e-7 > t
            ...
            var d = function (t, i, n, s) {
              ;(i = !1 !== i), (n = !1 !== n)
              for (
                var r, o, a = p((s = !1 !== s)), h = i && n && s, l = a.length;
                --l > -1;
            ...
            function (t, e, i) {
              ...
              return (
                ...
                (g.from = function (t, e, n, s) {
                  return this.add(
                    ((n.repeat && f.TweenMax) || i).from(t, e, n),
                    s
                  )
                }),
                (g.fromTo = function (t, e, n, s, r) {
                  ...
                  return e
                    ? this.add(o.fromTo(t, e, n, s), r)
                    : this.set(t, s, r)
                }),
                (g.staggerTo = function (t, e, s, r, o, a, l, u) {
                  var c,
                    f,
                    _ = new n({
                      onComplete: a,
                ...
                (g.staggerFromTo = function (t, e, i, n, s, r, o, a, h) {
                  return (
                    (n.startAt = i),
                    (n.immediateRender =
                      0 != n.immediateRender && 0 != i.immediateRender),
                ...
                (g.add = function (s, r, o, a) {
                  ...
                  if (
                    ...
                    for (
                      p = this, d = p.rawTime() > s._startTime;
                      p._timeline;
                ...
                (g.addPause = function (t, e, n, s) {
                  var r = i.delayedCall(0, _, n, s || this)
                  return (
              ...
              return (
                ...
                (c.render = function (t, e, i) {
                  ...
                  if (this._cycle !== T && !this._locked) {
                    ...
                    if (
                      ((this._totalTime = T * _),
                      this._cycle < T ? (w = !w) : (this._totalTime += _),
                      (this._time = m),
                  ...
                  if ((this._time !== m && this._first) || i || u || f) {
                    ...
                    this._onUpdate &&
                      (e || (o.length && h(), this._callback('onUpdate'))),
                      l &&
                        (this._locked ||
                          this._gc ||
                ...
                (c.getActive = function (t, e, i) {
                  ...
                  var n,
                    ...
                    a = 0,
                    h = o.length
                  for (n = 0; h > n; n++) (s = o[n]).isActive() && (r[a++] = s)
                  return r
                }),
          ...
          (function () {
            var t = 180 / Math.PI,
                ...
                for (l = 0; T > l; l++)
                  (u = (p = t[w]).a),
                    ...
                    a
                      ? ((v = e[l]),
                        (x = i[l]),
                        (b = ((x + v) * s * 0.25) / (o ? 0.5 : n[l] || 0.5)),
                        (d = c - (c - u) * (o ? 0.5 * s : 0 !== v ? b / v : 0)),
                        (_ = c + (f - c) * (o ? 0.5 * s : 0 !== x ? b / x : 0)),
                        (m =
                          c -
                          (d +
                            (((_ - d) * ((3 * v) / (v + x) + 0.5)) / 4 || 0))))
              ...
              u = function (t, n, s, r) {
                ...
                if (r)
                  for (t = [r].concat(t), h = t.length; --h > -1; )
                    'string' == typeof (f = t[h][n]) &&
                      '=' === f.charAt(1) &&
                      (t[h][n] = r[n] + Number(f.charAt(0) + f.substr(2)))
                if (0 > (a = t.length - 2))
              ...
              c = function (t, r, o, a, h, c) {
                ...
                if (t.length > 1) {
                  for (v = t[t.length - 1], y = !0, f = b.length; --f > -1; )
                    if (((p = b[f]), Math.abs(T[p] - v[p]) > 0.05)) {
                      y = !1
                      break
                    }
                  y &&
                ...
                if (!a) {
                  for (f = b.length; --f > -1; )
                    if (s[p])
                      for (d = x[b[f]], g = d.length - 1, _ = 0; g > _; _++)
                ...
                for (f = b.length, _ = o ? 4 : 1; --f > -1; )
                  (d = x[(p = b[f])]),
                    l(d, r, o, a, s[p]),
                    y && (d.splice(0, _), d.splice(d.length - _, _))
                return x
              },
              f = function (t, e, i) {
                var n,
                  ...
                  y = []
                if (
                  (g && i && (t = [i].concat(t)), null == t || t.length < m + 1)
                )
                  throw 'invalid Bezier data'
                for (f in t[0]) y.push(f)
                for (l = y.length; --l > -1; ) {
                  for (
                    f = y[l], _[f] = h = [], p = 0, c = t.length, u = 0;
                    c > u;
                    u++
                  )
                    (n =
              ...
              p = function (t, e, i) {
                for (
                  var n, s, r, o, a, h, l, u, c, f, p, d = 1 / i, _ = t.length;
                  --_ > -1;
                    ...
                    parser: function (t, e, r, o, a, h) {
                      ...
                      return (
                        ...
                        !m.autoRotate ||
                          ...
                          ((l = !0 === m.autoRotate ? 0 : Number(m.autoRotate)),
                          (m.autoRotate =
                            null != c.end.left
            ...
            function (t, e) {
              ...
              var f,
                ...
                Y = function (t, e) {
                  return X.createElementNS
                    ? X.createElementNS(e || 'http://www.w3.org/1999/xhtml', t)
                    : X.createElement(t)
                },
                U = Y('div'),
                H = Y('img'),
                q = (h._internals = { _specialProps: u }),
                ...
                tt = X.defaultView
                  ...
                  : function () {},
                et = (h.getStyle = function (t, e, i, n, s) {
                  var r
                  return G || 'opacity' !== e
                    ? (!n && t.style[e]
                        ? (r = t.style[e])
                ...
                it = (q.convertToPixels = function (t, i, n, s, r) {
                  ...
                  if ((p && (n = -n), d && (n *= 100), 'lineHeight' !== i || s))
                    if ('%' === s && -1 !== i.indexOf('border'))
                      ...
                      if (
                        ...
                        if (
                          ((c = t.parentNode || X.body),
                          -1 !== et(c, 'display').indexOf('flex') &&
                            (f.position = 'absolute'),
                          (a = c._gsCache),
                          (l = e.ticker.frame),
                          a && u && a.time === l)
                      ...
                      c.appendChild(U),
                        (o = parseFloat(U[u ? 'offsetWidth' : 'offsetHeight'])),
                        c.removeChild(U),
                        u &&
                          '%' === s &&
                          !1 !== h.cacheWidths &&
                ...
                nt = (q.calculateOffset = function (t, e, i) {
                  ...
                  return (
                    t['offset' + n] -
                    (it(t, e, parseFloat(s), s.replace(P, '')) || 0)
                  )
                }),
                st = function (t, e) {
                  var i,
                  ...
                  if ((e = e || tt(t, null)))
                    if ((i = e.length))
                      for (; --i > -1; )
                        (-1 === (s = e[i]).indexOf('-transform') || At === s) &&
                          (r[s.replace(I, E)] = e.getPropertyValue(s))
                    else
                      for (i in e)
                        (-1 === i.indexOf('Transform') || It === i) &&
                          (r[i] = e[i])
                ...
                ht = function (t, e, i) {
                  ...
                  for (i = i || tt(t, null); --r > -1; )
                    (n -= parseFloat(et(t, 'padding' + s[r], i, !0)) || 0),
                      (n -=
                        parseFloat(et(t, 'border' + s[r] + 'Width', i, !0)) ||
                        0)
                  return n
                },
                lt = function t(e, i) {
                  ...
                  return (
                    ...
                    ('center' === r ||
                      ...
                      (r = '50%'),
                    (e = r + ' ' + o + (s.length > 2 ? ' ' + s[2] : '')),
                    i &&
                      ((i.oxp = -1 !== r.indexOf('%')),
                      (i.oyp = -1 !== o.indexOf('%')),
                      (i.oxr = '=' === r.charAt(1)),
                      (i.oyr = '=' === o.charAt(1)),
                      (i.ox = parseFloat(r.replace(w, ''))),
                      (i.oy = parseFloat(o.replace(w, ''))),
                      (i.v = e)),
                    i || e
                  )
                },
                      ...
                      if (
                        ...
                        if (((i = f = t.match(x)), e)) {
                          ...
                          (o = (Number(i[0]) % 360) / 360),
                            ...
                            (i[1] = dt(o, n, s)),
                            (i[2] = dt(o - 1 / 3, n, s))
                      else i = t.match(x) || pt.transparent
                      ;(i[0] = Number(i[0])),
                        (i[1] = Number(i[1])),
                        (i[2] = Number(i[2])),
                ...
                mt = function (t, e) {
                  ...
                  for (i = 0; i < r.length; i++)
                    (n = r[i]),
                      (o +=
                        (s = t.substr(o, t.indexOf(n, o) - o)).length +
                        n.length),
              ...
              ;(gt = new RegExp(gt + ')', 'gi')),
                ...
                e.defaultStringFilter ||
                  (e.defaultStringFilter = h.colorStringFilter)
              var yt = function (t, e, i, n) {
                ...
                bt =
                  ((q._parseToProxy = function (t, e, i, n, s, r) {
                    var o,
                      a,
                      h,
                      l,
                    ...
                    for (
                      ...
                      if (
                        ...
                        (p[a] = n.s + n.c),
                        (f[a] = n.s),
                        r || ((l = new xt(n, 's', a, l, n.r)), (n.c = 0)),
                        1 === n.type)
                      )
                        for (o = n.l; --o > 0; )
                          (h = 'xn' + o),
                            (p[(a = n.p + '_' + h)] = n.data[h]),
                            (f[a] = n[h]),
                            r || (l = new xt(n, h, a, l, n.rxp[h]))
                      n = n._next
                    }
                    return { proxy: f, end: p, firstMPT: l, pt: u }
                  }),
                  (q.CSSPropTween = function (t, e, n, s, o, a, h, l, u, c, f) {
                    ;(this.t = t),
                      (this.p = e),
                      (this.s = n),
                      (this.c = s),
                ...
                wt = (h.parseComplex = function (t, e, i, n, s, r, o, a, l, u) {
                  ;(i = i || r || ''),
                    'function' == typeof n && (n = n(v, y)),
                    (o = new bt(t, e, 0, 0, o, u ? 2 : 1, null, !1, a, i, n)),
                    (n += ''),
                    s &&
                      gt.test(n + i) &&
                      ((n = [i, n]),
                  ...
                  for (
                    (-1 !== n.indexOf(',') || -1 !== i.indexOf(',')) &&
                      ((C = C.join(' ').replace(L, ', ').split(' ')),
                      (I = I.join(' ').replace(L, ', ').split(' ')),
                      (A = C.length)),
                      A !== I.length &&
                        ((C = (r || '').split(' ')), (A = C.length)),
                      o.plugin = l,
                      o.setRatio = u,
                      gt.lastIndex = 0,
                      c = 0;
                    ...
                    if (
                      ((_ = C[c]), (m = I[c]), (w = parseFloat(_)) || 0 === w)
                    )
                      o.appendXtra(
                        '',
                        w,
                      ...
                      (k = m.indexOf(')') + 1),
                        ...
                        (_ = _t(_, R)),
                        (m = _t(m, R)),
                        (P = _.length + m.length > 6) && !G && 0 === m[3]
                          ? ((o['xs' + o.l] += o.l
                              ? ' transparent'
                              : 'transparent'),
                            (o.e = o.e.split(I[c]).join('transparent')))
                          : (G || (P = !1),
                            R
                              ? o
                                  .appendXtra(
                      ...
                      if (!(T = m.match(b)) || T.length !== g.length) return o
                ...
                Pt = 9
              for ((c = bt.prototype).l = c.pr = 0; --Pt > 0; )
                (c['xn' + Pt] = 0), (c['xs' + Pt] = '')
              ;(c.xs0 = ''),
                (c._next = c._prev = c.xfirst = c.data = c.plugin = c.setRatio = c.rxp = null),
                (c.appendXtra = function (t, e, i, n, s, r) {
                  var o = this,
                    a = o.l
                  return (
                    (o['xs' + a] +=
                  ...
                  if (!u[t]) {
                    ...
                    Ot(t, {
                      parser: function (t, i, n, s, r, o, a) {
                        ...
                        return h
                          ? (h._cssRegister(), u[n].parse(t, i, n, s, r, o, a))
                          : (Q('Error: ' + e + ' js file not loaded.'), r)
                      },
                    })
                  }
                })
              ;((c = St.prototype).parseComplex = function (t, e, i, n, s, r) {
                var o,
                  a,
                  h,
                  l,
                ...
                (h.registerSpecialProp = function (t, e, i) {
                  Ot(t, {
                    parser: function (t, n, s, r, o, a, h) {
                      var l = new bt(t, s, 0, 0, o, 2, s, !1, i)
                      return (
                        (l.plugin = a), (l.setRatio = e(t, n, r._tween, s)), l
                      )
                    },
                    priority: i,
                  })
              ...
              var Rt,
                ...
                jt = function (t, e, i, n, s, r) {
                  ...
                  b && ((v = b.xOrigin), (x = b.yOrigin)),
                    ...
                    n &&
                      ...
                      (g = T[5]),
                      (y = f * _ - p * d) &&
                        ((a = u * (_ / y) + c * (-d / y) + (d * g - _ * m) / y),
                        (l = u * (-p / y) + c * (f / y) - (f * g - p * m) / y),
                        (u = i.xOrigin = o[0] = a),
                        (c = i.yOrigin = o[1] = l))),
                    b &&
                      (r &&
                        ...
                        (i.yOffset = b.yOffset),
                        (b = i)),
                      s || (!1 !== s && !1 !== h.defaultSmoothOrigin)
                        ? ((a = u - v),
                          (l = c - x),
                          (b.xOffset += a * T[0] + l * T[2] - a),
                          (b.yOffset += a * T[1] + l * T[3] - l))
                ...
                Ut = function (t, e) {
                  var i,
                    ...
                    o,
                    a,
                    h = t._gsTransform || new zt(),
                    l = t.style
                  if (
                    (It
                      ? (n = et(t, At, null, !0))
                      : t.currentStyle &&
                        ((n = t.currentStyle.filter.match(z)),
                        (n =
                          n && 4 === n.length
                            ? [
                                n[0].substr(4),
                    ...
                    !It ||
                      (!(a = 'none' === tt(t).display) && t.parentNode) ||
                      (a && ((r = l.display), (l.display = 'block')),
                      t.parentNode || ((o = 1), Ft.appendChild(t)),
                      (n = et(t, At, null, !0)),
                      (i =
                        !n || 'none' === n || 'matrix(1, 0, 0, 1, 0, 0)' === n),
                      r ? (l.display = r) : a && $t(l, 'display'),
                      o && Ft.removeChild(t)),
                    (h.svg || (t.getCTM && Xt(t))) &&
                      (i &&
                        -1 !== (l[It] + '').indexOf('matrix') &&
                        ((n = l[It]), (i = 0)),
                    ...
                    return Yt
                  for (s = (n || '').match(x) || [], Pt = s.length; --Pt > -1; )
                    (r = Number(s[Pt])),
                      (s[Pt] = (o = r - (r |= 0))
                ...
                Ht = (q.getTransform = function (t, i, n, s) {
                  ...
                  var r,
                    ...
                    _ = 1e5,
                    m = Mt
                      ? parseFloat(et(t, Et, i, !1, '0 0 0').split(' ')[2]) ||
                        f.zOrigin ||
                        0
                      : 0,
                    g = parseFloat(h.defaultTransformPerspective) || 0
                  if (
                    ((f.svg = !(!t.getCTM || !Xt(t))),
                    f.svg &&
                      (jt(
                    ...
                    if (16 === r.length) {
                      ...
                      f.zOrigin &&
                        ...
                        (B = Math.atan2(k, R)),
                        (f.scaleX =
                          ((Math.sqrt(w * w + P * P + S * S) * _ + 0.5) | 0) /
                          _),
                        (f.scaleY =
                          ((Math.sqrt(R * R + C * C) * _ + 0.5) | 0) / _),
                        (f.scaleZ =
                          ((Math.sqrt(A * A + E * E + M * M) * _ + 0.5) | 0) /
                          _),
                        (w /= f.scaleX),
                        (k /= f.scaleY),
                        (P /= f.scaleX),
                        ...
                        Math.abs(B) > d
                          ? ((f.skewX = B * j),
                            (k = 0),
                            'simple' !== f.skewType &&
                              (f.scaleY *= 1 / Math.cos(B)))
                          : (f.skewX = 0),
                        (f.perspective = F ? 1 / (0 > F ? -F : F) : 0),
                        (f.x = z),
                        (f.y = D),
                        (f.z = L),
                        f.svg &&
                          ((f.x -= f.xOrigin - (f.xOrigin * w - f.yOrigin * k)),
                      ...
                      ;(f.x = r[4] || 0),
                        ...
                        (a = Math.sqrt(W * W + X * X)),
                        (l = Math.sqrt(U * U + Y * Y)),
                        (u = W || X ? Math.atan2(X, W) * j : f.rotation || 0),
                        (c = Y || U ? Math.atan2(Y, U) * j + u : f.skewX || 0),
                        (f.scaleX = a),
                        (f.scaleY = l),
                        (f.rotation = u),
                        (f.skewX = c),
                        Mt &&
                          ...
                          (f.scaleZ = 1)),
                        f.svg &&
                          ((f.x -= f.xOrigin - (f.xOrigin * W + f.yOrigin * Y)),
                          (f.y -= f.yOrigin - (f.xOrigin * X + f.yOrigin * U)))
                    }
                    Math.abs(f.skewX) > 90 &&
                ...
                Vt = (q.set3DTransformRatio = q.setTransformRatio = function (
                  t
                ) {
                  var e,
                    i,
                      ...
                      R || C || 1 !== E
                        ? ((x +=
                          ...
                          (x +=
                            ...
                            b))
                        : (x += ',0,0,0,0,1,0,'),
                      (x += M + b + z + b + D + b + (F ? 1 + -D / F : 1) + ')'),
                      (O[It] = x)
                  }
                })
              ;((c =
                zt.prototype).x = c.y = c.z = c.skewX = c.skewY = c.rotation = c.rotationX = c.rotationY = c.zOrigin = c.xPercent = c.yPercent = c.xOffset = c.yOffset = 0),
                ...
                Ot(
                  'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
                  {
                    parser: function (t, e, i, n, r, a, l) {
                      ...
                      if (
                        ((C.skewType =
                          O.skewType || C.skewType || h.defaultSkewType),
                        (n._transform = C),
                        I && 'string' == typeof I && It)
                      )
                        (p = U.style),
                          (p[It] = I),
                          (p.display = 'block'),
                          ...
                          C.svg &&
                            ...
                            (O.transformOrigin || O.svgOrigin) &&
                              ...
                              (g = I.xOrigin),
                              (x = I.yOrigin),
                              (f.x -= I.xOffset - C.xOffset),
                              (f.y -= I.yOffset - C.yOffset)),
                            (g || x) &&
                              ((b = Ut(U, !0)),
                              (f.x -= g - (g * b[0] + x * b[2])),
                              (f.y -= x - (g * b[1] + x * b[3])))),
                          X.body.removeChild(U),
                          f.perspective || (f.perspective = C.perspective),
                          null != O.xPercent &&
                            (f.xPercent = ct(O.xPercent, C.xPercent)),
                          null != O.yPercent &&
                            (f.yPercent = ct(O.yPercent, C.yPercent))
                      else if (
                        'object' == (void 0 === O ? 'undefined' : o(O))
                      ) {
                        if (
                          ((f = {
                            scaleX: ct(
                            ...
                            scaleZ: ct(O.scaleZ, C.scaleZ),
                            x: ct(O.x, C.x),
                            y: ct(O.y, C.y),
                            z: ct(O.z, C.z),
                            xPercent: ct(O.xPercent, C.xPercent),
                            yPercent: ct(O.yPercent, C.yPercent),
                            perspective: ct(
                          ...
                          if ('object' == (void 0 === m ? 'undefined' : o(m)))
                            for (p in m) O[p] = m[p]
                          else O.rotation = m
                        'string' == typeof O.x &&
                          -1 !== O.x.indexOf('%') &&
                          ((f.x = 0), (f.xPercent = ct(O.x, C.xPercent))),
                          'string' == typeof O.y &&
                            -1 !== O.y.indexOf('%') &&
                            ((f.y = 0), (f.yPercent = ct(O.y, C.yPercent))),
                          (f.rotation = ft(
                            'rotation' in O
                              ? O.rotation
                              : 'shortRotation' in O
                          ...
                          (f.skewX = ft(O.skewX, C.skewX)),
                          (f.skewY = ft(O.skewY, C.skewY))
                      }
                      for (
                        Mt &&
                          null != O.force3D &&
                          ((C.force3D = O.force3D), (_ = !0)),
                          (d =
                            C.force3D ||
                            C.z ||
                            C.rotationX ||
                      ...
                      return (
                        ...
                        C.svg &&
                          ...
                          ((g = C.xOffset),
                          (x = C.yOffset),
                          jt(t, lt(I), f, O.svgOrigin, O.smoothOrigin),
                          (r = Tt(
                            C,
                            'xOrigin',
                            (w ? C : f).xOrigin,
                        ...
                        (I || (Mt && d && C.zOrigin)) &&
                          (It
                            ? ((_ = !0),
                              (T = Et),
                              (I = (I || et(t, T, s, !1, '50% 50%')) + ''),
                              (r = new bt(P, T, 0, 0, r, -1, R)),
                              (r.b = P[T]),
                              (r.plugin = a),
                              Mt
                                ? ((p = C.zOrigin),
                                  (I = I.split(' ')),
                                  (C.zOrigin =
                                    (I.length > 2 && (0 === p || '0px' !== I[2])
                                      ? parseFloat(I[2])
                                      : p) || 0),
                                  (r.xs0 = r.e =
                                    I[0] + ' ' + (I[1] || '50%') + ' 0px'),
                                  (r = new bt(C, 'zOrigin', 0, 0, r, -1, r.n)),
                                  (r.b = p),
                                  (r.xs0 = r.e = C.zOrigin))
                                : (r.xs0 = r.e = I))
                            : lt(I + '', C)),
                        _ &&
                          (n._transformType =
                            (C.svg && Rt) || (!d && 3 !== this._transformType)
                              ? 2
                              : 3),
                        u && (l[i] = u),
                        c && (l.scale = c),
                ...
                Ot('borderRadius', {
                  ...
                  parser: function (t, e, i, r, o, a) {
                    ...
                    for (
                      ...
                      this.p.indexOf('border') && (P[l] = K(P[l])),
                        -1 !==
                          (f = c = et(t, P[l], s, !1, '0px')).indexOf(' ') &&
                        ...
                        (x = '=' === p.charAt(1))
                          ? ((_ = parseInt(p.charAt(0) + '1', 10)),
                            ...
                            (_ *= parseFloat(p)),
                            (y =
                              p.substr((_ + '').length - (0 > _ ? 1 : 0)) ||
                              ''))
                          : ((_ = parseFloat(p)),
                            (y = p.substr((_ + '').length))),
                        '' === y && (y = n[i] || v),
                        y !== v &&
                          ((b = it(t, 'borderLeft', d, v)),
                          (T = it(t, 'borderTop', d, v)),
                          '%' === y
                            ? ((f = (b / m) * 100 + '%'),
                              (c = (T / g) * 100 + '%'))
                            : 'em' === y
                ...
                Ot('backgroundPosition', {
                  ...
                  parser: function (t, e, i, n, r, o) {
                    ...
                    if (
                      ...
                      m.split(',').length < 2 &&
                      (f = et(t, 'backgroundImage').replace(A, '')) &&
                      'none' !== f
                    ) {
                      for (
                        a = _.split(' '),
                ...
                parser: function (t, e, i, n, r, o) {
                  ...
                  return (
                    ...
                    l &&
                      ...
                      (a = 0),
                    G
                      ? (r = new bt(h, 'opacity', a, e - a, r))
                      : ((r = new bt(h, 'opacity', 100 * a, 100 * (e - a), r)),
                        (r.xn1 = l ? 1 : 0),
                        (h.zoom = 1),
                        (r.type = 2),
              ...
              Ot('className', {
                parser: function (t, e, n, r, o, a, h) {
                  var l,
                    ...
                    _ = t.style.cssText
                  if (
                    ((o = r._classNamePT = new bt(t, n, 0, 0, o, 2)),
                    (o.setRatio = Qt),
                    (o.pr = -11),
                    (i = !0),
                    (o.b = d),
                  ...
                  return (
                    ...
                    (o.data = l.firstMPT),
                    (t.style.cssText = _),
                    (o = o.xfirst = r.parse(t, l.difs, o, a))
                  )
                },
              })
              var Zt = function (t) {
              ...
              for (
                ...
                kt(c[Pt])
              ;((c =
                h.prototype)._firstPT = c._lastParsedTransform = c._transform = null),
                (c._onInitTween = function (t, e, o, a) {
                  ...
                  if (
                    ...
                    'string' == typeof e &&
                      ...
                      (S.cssText = g + ';' + e),
                      (l = rt(t, l, st(t)).difs),
                      !G && O.test(e) && (l.opacity = parseFloat(RegExp.$1)),
                      (e = l),
                      (S.cssText = g)),
                    e.className
                      ? (this._firstPT = c = u.className.parse(
                          t,
                          e.className,
                          'className',
                          this,
                    ...
                    for (
                      ...
                      _ = _._next
                    ;(w = new bt(t, 'transform', 0, 0, null, 2)),
                      this._linkCSSP(w, null, _),
                      (w.setRatio = It ? Vt : qt),
                      (w.data = this._transform || Ht(t, s, !0)),
                      (w.tween = o),
                      (w.pr = -1),
                      r.pop()
                  }
                  if (i) {
                    for (; c; ) {
                      for (b = c._next, _ = g; _ && _.pr > c.pr; ) _ = _._next
                      ;(c._prev = _ ? _._prev : x)
                        ? (c._prev._next = c)
                        : (g = c),
                        (c._next = _) ? (_._prev = c) : (x = c),
                        (c = b)
                    }
                    this._firstPT = g
                  }
                        ...
                        (m && R.test(p))
                          ? (m ||
                              ...
                              (p =
                                ...
                                p.join(',') +
                                ')')),
                            (i = wt(x, o, c, p, !0, 'transparent', i, 0, r)))
                          : m && F.test(p)
                          ? (i = wt(x, o, c, p, !0, null, i, 0, r))
                          : ((h = parseFloat(c)),
                ...
                (c._enableTransforms = function (t) {
                  ;(this._transform =
                    this._transform || Ht(this._target, s, !0)),
                    (this._transformType =
                      (this._transform.svg && Rt) ||
              ...
              var Kt = function t(e, i, n) {
                var s, r, o, a
                if (e.slice) for (r = e.length; --r > -1; ) t(e[r], i, n)
                else
                  for (s = e.childNodes, r = s.length; --r > -1; )
                    (a = (o = s[r]).type),
                      o.style && (i.push(st(o)), n && n.push(o)),
                      (1 !== a && 9 !== a && 11 !== a) ||
                        !o.childNodes.length ||
                        t(o, i, n)
              }
              return (
                (h.cascadeTo = function (t, i, n) {
                  var s,
                    r,
                    o,
                    a,
        ...
        (function (n, a) {
          ...
          if (!u.TweenLite) {
            var c,
              ...
              w = function n(o, l, c, f) {
                ...
                ;(this.check = function (d) {
                  for (var _, g, y, v, x = l.length, b = x; --x > -1; )
                    (_ = T[l[x]] || new n(l[x], [])).gsClass
                      ? ((p[x] = _.gsClass), b--)
                      : d && _.sc.push(this)
                  if (0 === b && c) {
                    if (
                      ((g = ('com.greensock.' + o).split('.')),
                      (y = g.pop()),
                      (v = m(g.join('.'))[y] = this.gsClass = c.apply(c, p)),
                      f)
                    )
                      if (((u[y] = h[y] = v), void 0 !== t && t.exports))
                        if (o === a) {
                          t.exports = h[a] = v
                          for (x in h) v[x] = h[x]
                        } else h[a] && (h[a][y] = v)
              ...
              P = (n._gsDefine = function (t, e, i, n) {
            ...
            var O = [0, 0, 1, 1],
              ...
              C = (k.register = function (t, e, i, n) {
                for (
                  ...
                  for (
                    r = h[l],
                      s = n ? S('easing.' + r, null, !0) : g.easing[r] || {},
                      o = u.length;
                    --o > -1;

                  )
                    (a = u[o]),
                      (R[r + '.' + a] = R[a + r] = s[a] = t.getRatio
                        ? t
                        : t[a] || new t())
              })
            for (
              (p = k.prototype)._calcEnd = !1,
                ...
                f = (c = ['Linear', 'Quad', 'Cubic', 'Quart', 'Quint,Strong'])
                  .length;
              --f > -1;

            )
              (p = c[f] + ',Power' + f),
                C(new k(null, null, 1, f), p, 'easeOut', !0),
                C(
                  new k(null, null, 2, f),
                  p,
                  'easeIn' + (0 === f ? ',easeNone' : '')
                ),
                C(new k(null, null, 3, f), p, 'easeInOut')
            ;(R.linear = g.easing.Linear.easeIn),
              (R.swing = g.easing.Quad.easeInOut)
            var I = S('events.EventDispatcher', function (t) {
              ;(this._listeners = {}), (this._eventTarget = t || this)
            })
            ;((p = I.prototype).addEventListener = function (t, e, i, n, s) {
              s = s || 0
              var r,
                o,
                a = this._listeners[t],
              ...
              for (
                ...
                (r = a[o]).c === e && r.s === i
                  ? a.splice(o, 1)
                  : 0 === h && r.pr < s && (h = o + 1)
              a.splice(h, 0, { c: e, s: i, up: n, pr: s })
            }),
            ...
            var A = n.requestAnimationFrame,
              ...
              z = M()
            for (
              f = (c = ['ms', 'moz', 'webkit', 'o']).length;
              --f > -1 && !A;

            )
              (A = n[c[f] + 'RequestAnimationFrame']),
                (E =
                  n[c[f] + 'CancelAnimationFrame'] ||
                  n[c[f] + 'CancelRequestAnimationFrame'])
            S('Ticker', function (t, e) {
              ...
              I.call(a),
                ...
                (a.lagSmoothing = function (t, e) {
                  ;(c = t || 1 / y), (f = Math.min(e, c, 0))
                }),
                (a.sleep = function () {
                  null != s &&
                    (u && E ? E(s) : clearTimeout(s),
                    (n = x),
                    (s = null),
                    a === d && (_ = !1))
                }),
              ...
              ((p = g.Ticker.prototype = new g.events.EventDispatcher()).constructor =
                g.Ticker)
            ...
            ;(d = D.ticker = new g.Ticker()),
              ((p = D.prototype)._dirty = p._gc = p._initted = p._paused = !1),
              (p._totalTime = p._time = 0),
              (p._rawPrevTime = -1),
              (p._next = p._last = p._onUpdate = p._timeline = p.timeline = null),
              (p._paused = !1)
            ;(function t() {
              _ && M() - z > 2e3 && 'hidden' !== l.visibilityState && d.wake()
              ...
              (p.totalTime = function (t, e, i) {
                if ((_ || d.wake(), !arguments.length)) return this._totalTime
                if (this._timeline) {
                  if (
            ...
            ;((p = L.prototype = new D()).constructor = L),
              (p.kill()._gc = !1),
              ...
              (p.rawTime = function () {
                return _ || d.wake(), this._totalTime
              })
            var F = S(
                'TweenLite',
                function (t, e, i) {
                      ...
                      (r = o[s])
                        ? 'string' != typeof r
                          ? r.length &&
                            ...
                            ? (o.splice(s--, 1),
                              (this._targets = o = o.concat(v(r))))
                            : ((this._siblings[s] = nt(r, this, !1)),
                              1 === h &&
                                this._siblings[s].length > 1 &&
                                rt(r, this, null, 1, this._siblings[s]))
                          : 'string' == typeof (r = o[s--] = F.selector(r)) &&
                            o.splice(s + 1, 1)
                        : o.splice(s--, 1)
                  else
                    (this._propLookup = {}),
            ...
            ;((p = F.prototype = new D()).constructor = F),
              (p.kill()._gc = !1),
              (p.ratio = 0),
              (p._firstPT = p._targets = p._overwrittenProps = p._startAt = null),
              (p._notifyPluginsOfEnabled = p._lazy = !1),
              (F.version = '1.20.2'),
              (F.defaultEase = p._ease = new k(null, null, 1, 1)),
              ...
              (F.selector =
                ...
                function (t) {
                  ...
                  return e
                    ...
                    : l.getElementById('#' === t.charAt(0) ? t.substr(1) : t)
                })
            var N = [],
              W = {},
              X = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
              ...
              H = function (t, e, i, n) {
                ...
                for (
                  ...
                  (u = r[a]),
                    (p +=
                      (l = e.substr(f, e.indexOf(u, f) - f)) || !a ? l : ','),
                    (f += l.length),
                  ...
                  ('number' != typeof p || ('number' != typeof n && !d)) &&
                    ...
                    'boolean' == typeof n
                      ? ((_.fp = a),
                        (u = H(
                          p,
                          d ? parseFloat(_.s) + _.c : n,
                          h || F.defaultStringFilter,
                          _
                        )),
                        (_ = {
                          t: u,
              ...
              K = (D._rootFramesTimeline = new L()),
              tt = (D._rootTimeline = new L()),
              et = 30,
              it = (V.lazyRender = function () {
                var t,
                  e = N.length
                for (W = {}; --e > -1; )
                  (t = N[e]) &&
            ...
            ;(tt._startTime = d.time),
              (K._startTime = d.frame),
              (tt._active = K._active = !0),
              setTimeout(it, 1),
              (D._updateRoot = F.render = function () {
                var t, e, i
                if (
                  (N.length && it(),
                  tt.render((d.time - tt._startTime) * tt._timeScale, !1, !1),
                  K.render((d.frame - K._startTime) * K._timeScale, !1, !1),
                  N.length && it(),
                  d.frame >= et)
                ) {
                  et = d.frame + (parseInt(F.autoSleep, 10) || 120)
                  for (i in $) {
                    for (t = (e = $[i].tweens).length; --t > -1; )
                      e[t]._gc && e.splice(t, 1)
                    0 === e.length && delete $[i]
                  }
                  if (
                    (!(i = tt._first) || i._paused) &&
                    F.autoSleep &&
                    !K._first &&
            ...
            var nt = function (t, e, i) {
                var n,
                  ...
                  r = t._gsTweenID
                if (
                  ($[r || (t._gsTweenID = r = 't' + Q++)] ||
                    ($[r] = { target: t, tweens: [] }),
                  e && ((n = $[r].tweens), (n[(s = n.length)] = e), i))
                )
              ...
              ot = function (t, e, i) {
                ...
                return (r /= s) > e
                  ? r - e
                  : (i && r === e) || (!t._initted && 2 * y > r - e)
                  ? y
                  : (r += t.totalDuration() / t._timeScale / s) > e + y
                  ? 0
                  : r - e - y
              }
            ;(p._init = function () {
              ...
              (p._initProps = function (t, e, i, s, r) {
                var o, a, h, l, u, c
                if (null == t) return !1
                W[t._gsTweenID] && it(),
                  this.vars.css ||
                    (t.style &&
                      ...
                      j(this.vars, t))
                for (o in this.vars)
                  if (((c = this.vars[o]), Z[o]))
                    c &&
                      (c instanceof Array || (c.push && b(c))) &&
                      -1 !== c.join('').indexOf('{self}') &&
                      (this.vars[o] = c = this._swapSelfInParams(c, this))
                  else if (
                    G[o] &&
                    (l = new G[o]())._onInitTween(t, this.vars[o], this, r)
                  ) {
                    for (
                      this._firstPT = u = {
                        _next: this._firstPT,
                  ...
                  (this._totalTime = this._time = h),
                    ...
                    0 === h &&
                      ...
                      (0 > l ||
                        ...
                        l !== t &&
                        ((i = !0), l > y && (s = 'onReverseComplete')),
                      (this._rawPrevTime = o = !e || t || l === t ? t : y))
                else if (1e-7 > t)
                  (this._totalTime = this._time = 0),
                    (this.ratio = this._ease._calcEnd
                      ? this._ease.getRatio(0)
                ...
                if ((b(e) || B(e)) && 'number' != typeof e[0])
                  ...
                  if (h) {
                    if (
                      ...
                      for (r in u) h[r] && (f || (f = []), f.push(r))
                      if ((f || !t) && !st(this, i, e, f)) return !1
                    }
                    for (r in u)
                      (a = h[r]) &&
                        (p &&
              ...
              (p._enabled = function (t, e) {
                if ((_ || d.wake(), t && this._gc)) {
                  var i,
                    n = this._targets
                  if (n)
                    for (i = n.length; --i > -1; )
                      this._siblings[i] = nt(n[i], this, !0)
              ...
              (F.getTweensOf = function (t, e) {
                ...
                if ((b(t) || B(t)) && 'number' != typeof t[0]) {
                  ...
                  for (n = nt(t).concat(), i = n.length; --i > -1; )
            ...
            if (
              ...
              (at.activate = function (t) {
                for (var e = t.length; --e > -1; )
                  t[e].API === at.API && (G[new t[e]()._propName] = t[e])
                return !0
              }),
              (P.plugin = function (t) {
                ...
                var e,
                  ...
                  a = (o.prototype = new at(i))
                ;(a.constructor = o), (o.API = t.API)
                for (e in r) 'function' == typeof t[e] && (a[r[e]] = t[e])
                return (o.version = t.version), at.activate([o]), o
              }),
              (c = n._gsQueue))
            ) {
              ...
              for (p in T)
                T[p].func ||
                  n.console.log('GSAP encountered missing dependency: ' + p)
            }
            _ = !1
          }
  ...
  function (t, e, i) {
    ...
    var n = (function (t) {
      ...
      a = {
        heading: 'snVote',
        subheading:
          'snVote allows you to create pools and share them with your friends.',
        description:
          'snVote is a voting application built with the MEAN stack. It features user\n                registration, authentication, event functions.',
  ...
  function (t, e, i) {
    ...
    !(function (i) {
      if ('undefined' != typeof requirejs) {
        var a = requirejs,
          h = '[history' + new Date().getTime() + ']',
          l = a.onError
        ;(i.toString = function () {
          return h
        }),
          (a.onError = function (t) {
            ;-1 === t.message.indexOf(h) && l.call(a, t)
          })
      }
      if (
        ((s = []),
        void 0 !== (r = 'function' == typeof (n = i) ? n.apply(e, s) : n) &&
          (t.exports = r),
        'object' !== o(e) || void 0 === t)
      )
        return i()
      ...
      function e(t, i, n) {
        ...
        if (null == t || '' === t || i)
          ...
          !n &&
            o &&
            o.getAttribute('href') &&
            ((o.href = o.href), (r = e(o.href, null, !0)))
          var a = r._pathname,
            h = r._protocol
          ;(t = '' + t),
            (t = /^(?:\w+\:)?\/\//.test(t)
        ...
        var l = s.exec(j.href),
          ...
          p = '#' === l[6] ? '' : l[6] || '',
          d = c + f + p,
          _ = c.replace(new RegExp('^' + F.basepath, 'i'), F.type) + f
        return {
          _href: l[1] + '//' + u + d,
          _protocol: l[1],
          _host: u,
      ...
      function i() {
        var t
        try {
          ;(t = _.sessionStorage).setItem(B + 't', '1'), t.removeItem(B + 't')
        } catch (e) {
          t = {
            getItem: function (t) {
              var e = g.cookie.split(t + '=')
              return (e.length > 1 && e.pop().split(';').shift()) || 'null'
            },
            setItem: function (t, e) {
              var i = {}
              ;(i[b.href] = w.state) && (g.cookie = t + '=' + x.stringify(i))
            },
          }
        }
        try {
          H = x.parse(t.getItem(B)) || {}
        } catch (t) {
          H = {}
        }
        z(
      ...
      function n(e, i, n, s) {
        ...
        try {
          R(e, i, h), (e[i] = e[i]), R(e, i, n)
        } catch (t) {}
        if (
          !(
            (o && a) ||
            (e.__defineGetter__ &&
              (e.__defineGetter__(i, h.get),
              e.__defineSetter__(i, h.set),
              (e[i] = e[i]),
              n.get && e.__defineGetter__(i, n.get),
              n.set && e.__defineSetter__(i, n.set)),
            o && a)
          )
        ) {
          if (r) return !1
          if (e === _) {
            ...
            if ('execScript' in _)
              _.execScript('Public ' + i, 'VBScript'),
                _.execScript('var ' + i + ';', 'JavaScript')
            else
              try {
                R(e, i, { value: t })
              } catch (t) {
            ...
            try {
              try {
                var u = v.create(e)
                R(v.getPrototypeOf(u) === e ? u : e, i, n)
                for (var c in e)
                  'function' == typeof e[c] && (u[c] = e[c].bind(e))
                try {
                  s.call(u, u, e)
                } catch (t) {}
                e = u
              } catch (t) {
                R(e.constructor.prototype, i, n)
              }
            } catch (t) {
              return !1
            }
      ...
      function r(e, i) {
        var s = ('' + ('string' == typeof e ? e : e.type)).replace(/^on/, ''),
          r = q[s]
        if (r) {
          if (null == (i = 'string' == typeof e ? i : e).target)
            for (
              var o = ['target', 'currentTarget', 'srcElement', 'type'];
              (e = o.pop());
          ...
          X &&
            (('popstate' === s ? _.onpopstate : _.onhashchange) || t).call(_, i)
          for (var a = 0, h = r.length; a < h; a++) r[a].call(_, i)
          return !0
        }
        return L(e, i)
      }
      function a() {
        var t = g.createEvent ? g.createEvent('Event') : g.createEventObject()
      ...
      function l(t, i, n, s) {
        if (O) N = b.href
          ...
          0 === U && (U = 2)
          var r = e(i, 2 === U && -1 !== ('' + i).indexOf('#'))
          r._relative !== e()._relative &&
            ((N = s), n ? b.replace('#' + r._special) : (b.hash = r._special))
        }
        !k && t && (H[b.href] = t), (Y = !1)
      }
      function u(t) {
        var i = N
        if (((N = b.href), i)) {
          W !== b.href && a(), (t = t || _.event)
          var n = e(i, !0),
            s = e()
          t.oldURL || ((t.oldURL = n._href), (t.newURL = s._href)),
            n._hash !== s._hash && r(t)
        }
      }
      function c(t) {
        setTimeout(function () {
          ...
          !O && !0 !== t && 'location' in w && (d(C.hash), h())
      }
      function f(t) {
        for (; t; ) {
      ...
      function p(t) {
        var i = t || _.event,
          n = f(i.target || i.srcElement),
          s =
            'defaultPrevented' in i ? i.defaultPrevented : !1 === i.returnValue
        if (n && 'A' === n.nodeName && !s) {
          var r = e(),
            o = e(n.getAttribute('href', 2))
          r._href.split('#').shift() === o._href.split('#').shift() &&
            o._hash &&
            (r._hash !== o._hash && (C.hash = o._hash),
            d(o._hash),
            i.preventDefault ? i.preventDefault() : (i.returnValue = !1))
        }
      }
      function d(t) {
        var e = g.getElementById((t = (t || '').replace(/^#/, '')))
        if (e && e.id === t && 'A' === e.nodeName) {
          var i = e.getBoundingClientRect()
          _.scrollTo(
            y.scrollLeft || 0,
            i.top + (y.scrollTop || 0) - (y.clientTop || 0)
          )
        }
      }
      var _ =
        ('object' === ('undefined' == typeof window ? 'undefined' : o(window))
          ? window
          : this) || {}
      if (!_.history || 'emulate' in _.history) return _.history
      var m,
        g = _.document,
        y = g.documentElement,
        v = _.Object,
        ...
        k = 'state' in T,
        R = v.defineProperty,
        C = n({}, 't') ? {} : g.createElement('a'),
        I = '',
        A = _.addEventListener
          ? 'addEventListener'
          : (I = 'on') && 'attachEvent',
        E = _.removeEventListener ? 'removeEventListener' : 'detachEvent',
        M = _.dispatchEvent ? 'dispatchEvent' : 'fireEvent',
        z = _[A],
        D = _[E],
        L = _[M],
        ...
        q = {},
        V = g.title,
        G = { onhashchange: null, onpopstate: null },
        $ = function (t, e) {
          var i = _.history !== T
          i && (_.history = T), t.apply(T, e), i && (_.history = w)
        },
        Q = {
          setup: function (t, e, i) {
            ;(F.basepath = ('' + (null == t ? F.basepath : t)).replace(
              /(?:^|\/)[^\/]*$/,
              '/'
            )),
              (F.type = null == e ? F.type : e),
              (F.redirect = null == i ? F.redirect : !!i)
          },
          redirect: function (t, i) {
            if ((w.setup(i, t), (i = F.basepath), _.top == _.self)) {
              var n = e(null, !1, !0)._relative,
                s = b.pathname + b.search
              O
                ? ((s = s.replace(/([^\/])$/, '$1/')),
                  n != i &&
                    new RegExp('^' + i + '$', 'i').test(s) &&
                    b.replace(n))
                : s != i &&
                  ((s = s.replace(/([^\/])\?/, '$1/?')),
                  new RegExp('^' + i, 'i').test(s) &&
                    b.replace(
                      i +
                        '#' +
                        s.replace(new RegExp('^' + i, 'i'), F.type) +
                        b.hash
                    ))
            }
          },
          ...
          state: {
            get: function () {
              return 'object' === o(H[b.href])
                ? x.parse(x.stringify(H[b.href]))
                : void 0 !== H[b.href]
                ? H[b.href]
                : null
            },
        ...
        Z = {
          assign: function (t) {
            O || 0 !== ('' + t).indexOf('#') ? b.assign(t) : l(null, t)
          },
          reload: function (t) {
            b.reload(t)
          },
          replace: function (t) {
            O || 0 !== ('' + t).indexOf('#') ? b.replace(t) : l(null, t, !0)
          },
          toString: function () {
            return this.href
          },
          origin: {
            get: function () {
              return void 0 !== m
                ...
                : b.origin
                ? b.origin
                : b.protocol + '//' + b.hostname + (b.port ? ':' + b.port : '')
            },
            set: function (t) {
              m = t
            },
      ...
      return (function () {
        var t = g.getElementsByTagName('script'),
          r = (t[t.length - 1] || {}).src || ''
        ;(-1 !== r.indexOf('?') ? r.split('?').pop() : '').replace(
          /(\w+)(?:=([^&]*))?/g,
          function (t, e, i) {
            F[e] = (i || '').replace(/^(0|false)$/, '')
          }
        ),
          z(I + 'hashchange', u, !1)
        var a = [Z, C, G, _, Q, w]
        ...
        for (var h = 0; h < a.length; h += 2)
          for (var l in a[h])
            if (a[h].hasOwnProperty(l))
              if ('object' !== o(a[h][l])) a[h + 1][l] = a[h][l]
              else {
                var f = s(a[h], l, a[h][l])
                if (
                  !n(a[h + 1], l, f, function (t, e) {
                    e === w && (_.history = w = a[h + 1] = t)
                  })
                )
                  return D(I + 'hashchange', u, !1), !1
                a[h + 1] === _ && (q[l] = q[l.substr(2)] = [])
              }
        return (
          w.setup(),
          F.redirect && w.redirect(),
          F.init && (U = 1),
          !k && x && i(),
          O || g[A](I + 'click', p, !1),
          'complete' === g.readyState
            ? c(!0)
            : (O || e()._relative === F.basepath || (Y = !0),
              z(I + 'load', c, !1)),
          !0
        )
      })()
  ...
  function (t, e, i) {
    ...
    function r() {
      var t = s(c.values)
      c.gridItems.forEach(function (e, i) {
        var n = e.querySelector('.gallery__fx')
        ;(e.style.width = t[i].width),
          (e.style.height = t[i].height),
          TweenMax.to(n, 0.4, {
            width: t[i].width,
            height: t[i].height,
            ease: Expo.easeInOut,
    ...
    function o() {
      ...
      if (!t || !t.getPropertyValue('content')) {
      ...
      return t.getPropertyValue('content').split('"').join('')
    }
    function a() {
      var t = o()
      return (
        (c.currentScreenSize = t),
        (c.containerWidth = c.container.clientWidth),
        r()
      )
    }
    Object.defineProperty(e, '__esModule', { value: !0 })
    var h = n(i(18)),
      ...
      f = function (t, e) {
        return function (i, n) {
          var s = Math.min(t / i, e / n)
          return { width: i * s + 'px', height: n * s + 'px' }
        }
      },
      p = function () {
      ...
      m = function (t, e) {
        return function (i) {
          ...
          var r = f(t, n),
            o = f(t, s)
          return i.map(function (t, e) {
            return e <= 1 ? r(t[0], t[1]) : o(t[0], t[1])
          })
        }
      },
      g = function (t, e) {
        return function (i) {
          return i.map(function (i) {
            var n = e(i)
            return f(t, n)(i[0], i[1])
          })
        }
      }
    window.addEventListener('resize', (0, h.default)(a, 200)),
      (e.default = function (t) {
        return function (e) {
          t(c.container, { background: !0 }, function () {
            return (
              (c.gridItems = [].slice.call(document.querySelectorAll('' + e))),
              (u = l.default.init()),
              (c.values = c.gridItems.map(function (t) {
                return JSON.parse(t.getAttribute('data-wh'))
              })),
              a()
            )
          })
  ...
  function (t, e, i) {
    ...
    Object.defineProperty(e, '__esModule', { value: !0 }),
      (e.default = function (t, e, i) {
        ...
        return function () {
          for (
            var s = this, r = arguments.length, o = Array(r), a = 0;
            a < r;
            a++
          )
            o[a] = arguments[a]
    ...
    e.default = (function () {
      var t = {
          ...
          config: {
            ...
            initLayout: !1,
            isInitLayout: !1,
            fitRows: { columnWidth: '.gallery__sizer' },
          },
        },
        e = void 0,
        i = void 0
      return {
        init: function (r) {
          return (e = n({}, t, r)), (i = new s.default(e.container, e.config))
        },
      }
    })()
  },
  function (t, e, i) {
    ...
    'function' == typeof Symbol && Symbol.iterator
    !(function (r, o) {
      ;(n = [i(1), i(0), i(6), i(5), i(26), i(2), i(22), i(24), i(25)]),
        void 0 !==
          (s = function (t, e, i, n, s, a) {
      ...
      ;(c._create = function () {
        ...
        (c._filter = function (t) {
          ...
          e = e || '*'
          for (
            var i = [], n = [], s = [], r = this._getFilterTest(e), o = 0;
            o < t.length;
            o++
          ) {
            var a = t[o]
  ...
  function (t, e, i) {
    ...
    var n = document.getElementById('loader'),
      ...
      o = document.getElementById('icon')
    e.curtain = {
      open: function (t) {
        ...
        return (
          e
            ...
            .to(
              s,
              0.5,
              { x: '-100%', ease: Power2.easeInOut, force3D: !0 },
              'curtain'
            )
            .to(
              r,
        ...
        return (
          e
            ...
            .to(
              s,
              0.5,
              { x: '0%', ease: Power2.easeInOut, force3D: !0 },
              'curtain'
            )
            .to(
              r,
